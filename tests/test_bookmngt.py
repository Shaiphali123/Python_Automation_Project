...
async def test_create_book(mock_db):
    ...
    response = await create_book(book=book_data, db=mock_db)
...
async def test_update_book(mock_db):
    ...
    response = await update_book(book_id=book_id, update_data=updated_data, db=mock_db)
...
async def test_update_book_not_found(mock_db):
    ...
    with pytest.raises(HTTPException) as excinfo:
        await update_book(book_id=book_id, update_data=updated_data, db=mock_db)
...
async def test_delete_book(mock_db):
    ...
    response = await delete_book(book_id=book_id, db=mock_db)
...
async def test_delete_book_not_found(mock_db):
    ...
    with pytest.raises(HTTPException) as excinfo:
        await delete_book(book_id=book_id, db=mock_db)
...
async def test_get_book_by_id(mock_db):
    ...
    response = await get_book_by_id(book_id=book_id, db=mock_db)
...
async def test_get_book_by_id_not_found(mock_db):
    ...
    with pytest.raises(HTTPException) as excinfo:
        await get_book_by_id(book_id=book_id, db=mock_db)
